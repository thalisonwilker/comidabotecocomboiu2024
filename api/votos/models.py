...
class Bar(models.Model):
    ...
    nome = models.CharField(max_length=20, verbose_name="Nome do Bar", help_text="Máximo 50 caractares")
    url_bar = models.CharField(max_length=50, verbose_name="URL do bar", help_text="Digite somente o caminho, ex /trauko, /toro")
