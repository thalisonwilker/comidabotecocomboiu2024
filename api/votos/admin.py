...
def export_to_excel(modeladmin, request, queryset):
    ...
    ws.append(["Bar", "CPF", "Apresentação do Prato", "Aroma do Prato",
              "Sabor do Prato", "Tempo de espera", "Bebida", "Higiene do local", "Hambiente"])
    ws2.append(["Bar", "Apresentação do Prato", "Aroma do Prato", "Sabor do Prato",
    ...
    for obj in Votos.objects.all():
        row = [obj.bar.nome, obj.cpf, obj.apresentacao_prato, obj.aroma_prato,
               obj.sabor_prato, obj.tempo_espera, obj.bebida, obj.higiene_local, obj.ambiente]
        ws.append(row)
    ...
    for aba2 in data_obj.keys():
        ...
        row = [aba2, total_apresentacao_prato, total_aroma_prato, total_aroma_prato, total_sabor_prato, total_tempo_espera, total_bebida, total_higiene_local, total_ambiente]
        ws2.append(row)
